...
import HowItWorksStep from "../../../components/old/HowItWorksStep/HowItWorksStep";

import { useScrollEffect } from "../../../hooks/useScrollEffect";

// @ts-ignore
import howItWorks1Img from "../../../assets/img/old/scroll1.png";
// @ts-ignore
import howItWorksMobile1Img from "../../../assets/img/old/scrollMobile1.png";
// @ts-ignore
import howItWorks2Img from "../../../assets/img/old/scroll2.png";
// @ts-ignore
import howItWorksMobile2Img from "../../../assets/img/old/scrollMobile2.png";
// @ts-ignore
import howItWorks3Img from "../../../assets/img/old/scroll3.png";
// @ts-ignore
import howItWorksMobile3Img from "../../../assets/img/old/scrollMobile3.png";
// @ts-ignore
import frameImg from "../../../assets/img/old/frame.png";
// @ts-ignore
import frameMobileImg from "../../../assets/img/old/frameMobile.png";
// @ts-ignore
import slackIcon from "../../../assets/img/old/icons/slack.svg";
// @ts-ignore
import teamsIcon from "../../../assets/img/old/icons/teams.svg";
    ...
    <div className="HowItWorksContainer">
      <div className="HowItWorksContainer-wrapper">
        ...
        <div style={style} ref={ref} className="HowItWorks">
          <div
            style={styleSub}
            className={scrolling ? "HowItWorks-startEffect" : undefined}
          >
            <div>
              {/*    <div>*/}
              <HowItWorksStep
