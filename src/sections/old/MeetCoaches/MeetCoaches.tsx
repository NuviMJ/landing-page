...
// @ts-ignore
import amelieImg from "../../../assets/img/old/ourCoaches/amelie.svg";
// @ts-ignore
import sandrineImg from "../../../assets/img/old/ourCoaches/sandrine.svg";
// @ts-ignore
import stasImg from "../../../assets/img/old/ourCoaches/stas.svg";
// @ts-ignore
import mirjanaImg from "../../../assets/img/old/ourCoaches/mirjana.svg";
// @ts-ignore
import oliverImg from "../../../assets/img/old/ourCoaches/oliver.svg";
    ...
    <div className="MeetCoaches">
      <div className="MeetCoaches-wrapper">
        ...
        <div className="MeetCoaches-imgContainer">
          ...
          <div>
            <h4>Sandrine</h4>
            <img src="https://i.ibb.co/QnZ6mkp/DSC-4824-bewerkt-Sandrine-Bostyn-NEWUX.jpg" />
          </div>
          <div>
            <h4>Stas</h4>
            <img
              src={
                "https://i.ibb.co/xDtr19N/stasfinals-face-Stas-Gromin-NEWUX.jpg"
              }
            />
          </div>
          <div>
            ...
            <img
              src={
                "https://i.ibb.co/1mDDX8j/NEB03385-Mirjana-Gomilanovic-NEWUX.jpg"
              }
            />
          </div>
          <div>
            ...
            <img
              src={
                "https://i.ibb.co/QCv1Gw9/O-FRIEDMAN-Olivier-Friedman-Prism-Up-NEWUX.jpg"
              }
            />
          </div>
        </div>
