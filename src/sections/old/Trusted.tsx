...
// @ts-ignore
import progress1Img from "../../assets/img/old/progress1.png";
// @ts-ignore
import progress2Img from "../../assets/img/old/progress2.png";
// @ts-ignore
import thrustedImg from "../../assets/img/old/thrustedRight.png";
