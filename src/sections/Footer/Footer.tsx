...
// @ts-ignore
import laFrenchTechLogo from "../../assets/img/old/La French Tech.png";
// @ts-ignore
    ...
    <footer className="Footer">
      <div>
        <div className="Footer-logoContainer">
          ...
          <p>
            Empower your team with professional <br /> coaching and get strong
            ROI.
            <br /> Seamless integration in Slack and
            <br />
            Teams.
          </p>
        </div>
        ...
        <div className="Footer-contentContainer">
          ...
          <a href="https://legal.coachello.io/en/">
            <p>Legal & Admin Support</p>
          </a>
