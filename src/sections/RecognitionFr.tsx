  ...
  return (
    <div className="section bg-white flex flex-col md:flex-row">
      <div className=" flex-1">
        ...
        <h2 className="mb-4">De nos partenaires. </h2>
      </div>
      <div className="grid md:grid-cols-2 flex-1 gap-8">
        <div className="p-8 border border-gray/20 rounded">
          ...
          <p>
            Sélectionné dans le programme Future of Work de Slack pour les
            entreprises qui améliorent le future du monde du travail.{" "}
          </p>
        </div>
        <div className="p-8 border border-gray/20 rounded">
