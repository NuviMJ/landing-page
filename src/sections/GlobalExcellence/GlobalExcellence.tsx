...
// @ts-ignore
import ExcellenceImg from "../../assets/img/old/excellence.png";
    ...
    <div className="GlobalExcellence">
      <div>
        <div className="GlobalExcellence-contentContainer">
          <div>
            <p className="h1-red">Global Excellence</p>
            <h2>
              Your team is global?
              <br />
              So is ours.
        ...
        <div className="GlobalExcellence-imgContainer">
          ...
          {/*  muted={true}*/}
          {/*  url={*/}
          {/*    "https://d1x3hp8oc8irfp.cloudfront.net/coachello-coaches-testimonies.mp4"*/}
          {/*  }*/}
          {/*/>*/}
