...
const LeadershipCoaching = () => {
    return (
        <ImgContentTemplateRed img={leadershipCoachingImg}
                               titleE={
                               ...
                               desE={<> <p>Global Excellence - is what we require from our coaches. We determine their
                                   excellence by a two-step interview process, reference checks, assessments, and by
                                   monitoring their performance we can guarantee the coaching quality to all
                                   stakeholders.</p>
                               </>}/>
