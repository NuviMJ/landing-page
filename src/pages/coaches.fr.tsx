    ...
    <>
      ...
      <CoachProfile
        ...
        desE={
          <>
            <p>
              ICF PCC qualified coach, former top tier lawyer (Paris & NY Bar),
              trainer and theatre actress. Is there anything she cannot do? Not
              that we can think of.
            </p>{" "}
            <p>
              Knowledgeable, approachable and always in a good mood to advice
              our clients on their (individual) coaching programs. Furthermore,
              she animes our pool of coaches and helps onboard our clients.
            </p>
            <p>
